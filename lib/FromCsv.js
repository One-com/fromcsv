...
module.exports = function FromCsv(options) {
  ...
  var processRow = options.processRow || _processRow;
  var processRowCoalesce =
    options.processRowCoalesce ||
    function(obj) {
      return obj;
    };
  ...
  function _processRow(csvConfig, headerInfo, dataRow) {
    ...
    return processRowCoalesce(contact, unknowns);
  }
